...
var $author$project$User$initialUsers = _List_fromArray(
	[
		{name: 'Ana', points: 12, uid: 1},
		{name: 'Berta', points: 17, uid: 2},
		{name: 'Cilka', points: -2, uid: 3}
	]);
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$App$initialModel = function (_v0) {
	return _Utils_Tuple2(
		{numberOfClicks: 0, users: $author$project$User$initialUsers, value: 0},
		...
		switch (msg.$) {
			case 'Increment':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{numberOfClicks: model.numberOfClicks + 1, value: model.value + 1}),
					$elm$core$Platform$Cmd$none);
			case 'Decrement':
				return _Utils_Tuple2(
					_Utils_update(
			...
			case 'Duplicate':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{numberOfClicks: model.numberOfClicks + 1, value: model.value * 2}),
					$elm$core$Platform$Cmd$none);
			case 'Reset':
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							$elm$core$String$fromInt(model.numberOfClicks))
						])),
					A2(
					...
					_List_fromArray(
						[
							...
							$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$App$Increment)
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$App$Decrement)
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$App$Duplicate)
						]),
					_List_fromArray(
						[
					...
					_List_fromArray(
						[
							...
							$rundis$elm_bootstrap$Bootstrap$Button$onClick($author$project$App$Reset)
						]),
					_List_fromArray(
						[
...
var $author$project$App$main = $elm$browser$Browser$element(
	{
		init: $author$project$App$initialModel,
